...
public class HTMLTagChecked {
    public static void main(String[] args) {

        String str="<div><b><p>hello</p></b></div>";
...
/*    public static String HTMLElements(String str){
        ...
        for (String srtRep :
                array) {
            System.out.println(srtRep);
        }
        return strRep;
    }*/
}
/*
HTML Elements Have the function HTMLElements (str) read the str parameter being passed which will be
a string of HTML DOM elements and plain text.
